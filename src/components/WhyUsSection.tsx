...
const WhyUsSection = () => {
  const differentials = [
    {
      ...
      description:
        "Peças de marcas referência mundial. Garantia de peças até 6 meses garantida em cada componente.",
    },
    {
      title: "Garantia de peças até 6 meses",
      description:
        "Nossos produtos possuem garantia de peças até 6 meses. Trabalhe com tranquilidade sabendo que está protegido.",
    },
    {
      title: "Entrega Rápida para Oficinas",
      description:
        "Sabemos que oficina parada é prejuízo. Entregamos com agilidade para você não perder tempo.",
    },
    {
      title: "Estacionamento Gratuito",
      description:
        "Localizado no centro de Castanhal com estacionamento próprio. Acesso fácil para você e sua equipe.",
    },
    {
      title: "Múltiplas Formas de Pagamento",
      description:
        "Cartão de crédito, débito e boleto. Condições especiais para oficinas parceiras.",
    },
    {
      title: "Atendimento Varejo e Atacado",
      description:
        "Seja você consumidor final ou dono de oficina, temos o atendimento certo para sua necessidade.",
    },
  ];
  ...
  return (
    <section
      id="diferenciais"
      className="bg-white dark:bg-[#0A0A0A] py-20 sm:py-32 px-[max(24px,5vw)] overflow-hidden transition-colors duration-500"
    >
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="font-['Inter'] text-[20px] font-light text-slate-700 dark:text-[#B8C8DC] leading-[1.8] italic mb-10">
                "Trabalhamos com marcas líderes mundiais em peças para sistemas de ar-condicionado
                automotivo."
              </p>

              <div className="flex items-center gap-4 mb-10">
                <span className="font-['Bebas_Neue'] text-2xl text-slate-900 dark:text-[#F5F8FF]">
                  HCB
                </span>
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    <div className="font-['Rajdhani'] text-[15px] text-slate-600 dark:text-[#8A9BB5] uppercase font-bold mb-1">
                      Endereço
                    </div>
                    <div className="font-['Rajdhani'] text-[15px] text-slate-800 dark:text-[#B8C8DC]">
                      Tv. Primeiro de Maio, 1.719
                      <br />
                      Centro — Castanhal, PA
                    </div>
                  </div>
