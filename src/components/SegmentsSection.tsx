...
const SegmentCard = ({ 
  ...
  >
    ...
    <div className="relative h-48 overflow-hidden">
      ...
      />
      <div className="absolute inset-0 bg-gradient-to-t from-white via-white/40 dark:from-[#16191F] dark:via-[#16191F]/40 to-transparent" />
    ...
    <div className="p-10 pt-6">
      <h3 className="font-['Bebas_Neue'] text-[36px] text-slate-900 dark:text-[#F5F8FF] mb-6 uppercase tracking-wider group-hover:text-[#0066CC] dark:group-hover:text-[#60C0FF] transition-colors">
        {title}
      </h3>
