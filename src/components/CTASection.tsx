        ...
        >
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4 mb-16">
            ...
            <a 
              ...
              className="w-full sm:w-auto flex items-center justify-center gap-3 px-12 py-5 bg-transparent border border-[#0066CC]/40 rounded-[12px] font-['Rajdhani'] text-[18px] font-bold text-[#60C0FF] transition-all duration-300 hover:bg-[#0066CC]/10"
            >
