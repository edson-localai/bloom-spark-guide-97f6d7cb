  ...
  vendedor: [
      ...
      lessons: [
        {
          ...
          quiz: [
            {
              id: "q1",
              question: "Qual a principal função do Inbox?",
              options: ["Organizar conversas", "Gerar relatórios", "Configurar o bot"],
              correctAnswer: 0,
            },
          ],
        },
        {
          ...
          quiz: [
            {
              id: "q2",
              question: "Para que servem as respostas rápidas?",
              options: [
        ...
        {
          id: "v-l3",
          title: "3. Gestão de Contatos",
          description: "Cadastrando veículos e informações vitais do cliente.",
          duration: "7 min",
          type: "video",
          icon: Users,
        },
    ...
    },
    {
      ...
      lessons: [
        {
          id: "v-l4",
          title: "1. O Poder do Kanban",
          description: "Como mover leads pelo funil até o fechamento.",
          duration: "10 min",
          type: "video",
          icon: Kanban,
        },
        {
          id: "v-l5",
          title: "2. Propostas Imbatíveis",
          description: "Criando orçamentos profissionais em PDF que vendem por você.",
          duration: "12 min",
          type: "video",
          icon: FileText,
        },
        {
          ...
          description: "Como usar o histórico do CRM para converter mais.",
          duration: "8 min",
          type: "video",
          icon: CheckCircle2,
        },
  ...
  gerente: [
    {
      ...
      lessons: [
        {
          id: "g-l1",
          title: "1. Supervisão de Atendimento",
          description: "Como monitorar a qualidade e o tom de voz da equipe.",
          duration: "10 min",
          type: "video",
          icon: Users,
        },
        {
          id: "g-l2",
          title: "2. Análise de Funil",
          description: "Identificando gargalos no Kanban da equipe.",
          duration: "15 min",
          type: "video",
          icon: BarChart3,
        },
        {
          ...
          description: "Extraindo dados para tomada de decisão.",
          duration: "12 min",
          type: "video",
          icon: FileText,
        },
      ...
      lessons: [
        {
          ...
          description: "Gerenciando usuários, senhas e níveis de permissão.",
          duration: "7 min",
          type: "video",
          icon: ShieldCheck,
        },
        {
          id: "a-l2",
          title: "2. Conectividade WhatsApp",
          description: "Manutenção de instâncias e estabilidade do sistema.",
          duration: "15 min",
          type: "video",
          icon: Settings,
        },
        {
          id: "a-l3",
          title: "3. Automações Globais",
          description: "Configurando respostas automáticas e fluxos do CRM.",
          duration: "20 min",
          type: "video",
          icon: Smartphone,
        },
...
function TreinamentoPage() {
  ...
  const progressPercent =
    allLessons.length > 0
      ? Math.round(
          (completedLessons.filter((id) => allLessons.some((l) => l.id === id)).length /
            allLessons.length) *
            100,
        )
      : 0;
  ...
  const handleQuizAnswer = (optionIndex: number) => {
    ...
    if (currentQuestionIndex < activeQuiz.length - 1) {
      ...
      if (selectedLesson) {
        saveQuizResult(
          selectedLesson.id,
          quizScore + (optionIndex === activeQuiz[currentQuestionIndex].correctAnswer ? 1 : 0),
          activeQuiz.length,
        );
      }
    }
    ...
    <div className="h-full flex flex-col bg-[#0A0A0F]">
      ...
      <div className="p-8 pb-4">
        ...
        <p className="text-zinc-500 text-sm">
          Cursos especializados para sua função de{" "}
                ...
                <div className="grid gap-3">
                  {module.lessons.map((lesson) => {
                    ...
                    return (
                      ...
                      >
                        <div
                          className={`h-12 w-12 rounded-xl flex items-center justify-center transition-colors relative ${
                            selectedLesson?.id === lesson.id
                        ...
                        <div className="flex-1 min-w-0">
                          <h3
                            className={`font-semibold mb-0.5 ${isCompleted ? "text-zinc-400" : "text-white"}`}
                          >
                            {lesson.title}
                            {isCompleted && (
                              <span className="ml-2 text-[9px] text-emerald-500 bg-emerald-500/10 px-1.5 py-0.5 rounded">
                                Concluído
                              </span>
                            )}
                          </h3>
                        ...
                        <div className="text-right shrink-0">
                          <span className="text-[10px] font-bold text-zinc-600 block mb-1 uppercase tracking-wider">
                            {lesson.duration}
                          </span>
              ...
              {selectedLesson ? (
                ...
                >
                  <div className="aspect-video bg-zinc-900 flex items-center justify-center border-b border-[#1F232E] relative group cursor-pointer">
                    ...
                    <div className="absolute bottom-4 left-4 right-4 flex justify-between items-center">
                      <span className="text-[10px] font-bold bg-black/60 px-2 py-1 rounded-md text-white backdrop-blur-sm">
                        PLAYER HCB
                      </span>
                      <span className="text-[10px] font-bold bg-cyan-500 px-2 py-1 rounded-md text-black">
                      ...
                      {selectedLesson.quiz && !activeQuiz && (
                        <div className="p-4 rounded-2xl bg-cyan-500/5 border border-cyan-500/10">
                          ...
                          <p className="text-xs text-zinc-500 mb-4">
                            Complete o quiz para confirmar seu aprendizado nesta aula.
                          </p>
                          <button
                            onClick={startQuiz}
                        ...
                        <div className="p-5 rounded-2xl bg-[#151821] border border-[#1F232E]">
                          <div className="flex justify-between items-center mb-4">
                            <span className="text-[10px] font-bold text-zinc-500 uppercase">
                              Questão {currentQuestionIndex + 1}/{activeQuiz.length}
                            </span>
                            <div className="h-1.5 w-24 bg-zinc-800 rounded-full overflow-hidden">
                              <div
                                className="h-full bg-cyan-500 transition-all"
                                style={{
                                  width: `${((currentQuestionIndex + 1) / activeQuiz.length) * 100}%`,
                                }}
                              />
                            </div>
                          </div>
                      ...
                      {showQuizResult && (
                        ...
                        >
                          ...
                          <p className="text-sm text-zinc-400 mb-4">
                            Você acertou {quizScore} de {activeQuiz?.length} questões.
                          </p>
                          <button
                ...
                <div className="bg-[#151821] border border-dashed border-[#1F232E] rounded-3xl p-12 text-center">
                  ...
                  <p className="text-sm text-zinc-500 leading-relaxed">
                    Clique em qualquer aula ao lado para iniciar seu treinamento e dominar o sistema
                    HCB.
                  </p>
                </div>
              )}
              ...
              <div className="bg-[#0F1117] border border-[#1F232E] rounded-3xl p-6">
                ...
                <div className="space-y-6">
                        ...
                        .map(([id, result]) => {
                          ...
                          return (
                            <div key={id} className="flex items-center justify-between gap-3">
                              <div className="flex-1 min-w-0">
                                <p className="text-[10px] text-zinc-300 truncate font-semibold">
                                  {lesson.title}
                                </p>
                              ...
                              <span
                                className={`text-[10px] font-black ${scorePercent >= 70 ? "text-emerald-500" : "text-amber-500"}`}
                              >
                  ...
                  <div className="flex items-center gap-2 text-[10px] text-zinc-600 font-bold uppercase tracking-wider">
                    ...
                    {progressPercent === 100
                      ? "Parabéns! Você é um HCB Expert!"
                      : "Continue para ganhar seu selo"}
                  </div>
                </div>
              </div>
            </div>
