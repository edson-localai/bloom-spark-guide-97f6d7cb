...
function InboxPage() {
  ...
  const renderSidebar = () => (
    <div
      className="w-16 md:w-48 shrink-0 flex flex-col border-r border-[#1F232E]"
      ...
      <div className="h-full flex flex-col">
        {filter === "profile" ? (
          <div className="flex-1 overflow-auto custom-scrollbar bg-[#0A0A0F]">
            <div
              className="p-4 border-b border-[#1F232E] flex items-center gap-3 shrink-0"
          ...
          <>
            <div
              ...
              style={{ background: "#0F1117", borderBottom: "1px solid #1F232E" }}
            >
      ...
      <div className="flex-1 h-full min-w-0 flex overflow-hidden">
        {filter === "profile" ? (
          <div className="flex-1 overflow-auto custom-scrollbar">
            <div
              className="p-8 border-b border-[#1F232E] flex justify-between items-center"
              style={{ background: "#0F1117" }}
            >
              <div>
          ...
          <>
            <div
              className="w-72 lg:w-80 shrink-0 h-full flex flex-col border-r border-[#1F232E]"
              style={{ background: "#0F1117" }}
            >
