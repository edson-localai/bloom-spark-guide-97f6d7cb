...
function ProposalPage() {
  ...
  const handlePlanSelect = (plan: any) => {
    ...
    setCustomMessage(
      `Olá! Confirmo meu interesse no ${plan.name} para a HCB Ar Condicionado. Como podemos prosseguir?`,
    );
      ...
      features: [
        {
          ...
          text: "Domínio Profissional",
          subtext: "Seu endereço exclusivo na web",
        },
        {
          icon: <Server className="w-4 h-4" />,
          text: "Hospedagem de Elite",
          subtext: "Velocidade e estabilidade",
        },
        {
          icon: <Mail className="w-4 h-4" />,
          text: "Contas de E-mail @hcb",
          subtext: "Credibilidade em cada contato",
        },
        {
          icon: <Lock className="w-4 h-4" />,
          text: "Certificado SSL",
          subtext: "Site seguro e confiável",
        },
        {
          icon: <HelpCircle className="w-4 h-4" />,
          text: "Suporte Técnico",
          subtext: "Auxílio sempre que precisar",
        },
      ],
      ...
      features: [
        {
          ...
          subtext: "Design focado em conversão",
        },
        {
          icon: <Palette className="w-4 h-4" />,
          text: "Identidade Visual",
          subtext: "Visual moderno e impactante",
        },
        {
          icon: <Search className="w-4 h-4" />,
          text: "Otimização SEO",
          subtext: "Apareça no topo das buscas",
        },
        {
          icon: <MessageSquare className="w-4 h-4" />,
          text: "Botão WhatsApp",
          subtext: "Contato imediato e fácil",
        },
        {
          icon: <Zap className="w-4 h-4" />,
          text: "Alta Performance",
          subtext: "Carregamento ultra-rápido",
        },
      ],
      ...
      features: [
        {
          ...
          text: "Automação WhatsApp",
          subtext: "Atendimento automático 24h",
        },
        {
          icon: <Users className="w-4 h-4" />,
          text: "CRM Estratégico",
          subtext: "Gestão profissional de leads",
        },
        {
          icon: <BarChart3 className="w-4 h-4" />,
          text: "Relatórios de Vendas",
          subtext: "Decisões baseadas em dados",
        },
        {
          icon: <Star className="w-4 h-4" />,
          text: "Suporte VIP",
          subtext: "Atendimento priorizado",
        },
        {
          icon: <Zap className="w-4 h-4" />,
          text: "Escalabilidade",
          subtext: "Pronto para crescer rápido",
        },
      ],
        ...
        <div className="container mx-auto px-6 flex justify-between items-center">
          ...
          >
            ...
            <div className="hidden sm:flex flex-col">
              <span className="font-['Bebas_Neue'] text-[26px] leading-none text-[#F5F8FF] tracking-wide group-hover:text-[#60C0FF] transition-colors uppercase">
                HCB
              </span>
      ...
      <main>
          ...
          <div className="container mx-auto px-6 text-center">
            ...
            >
              ...
              <p className="text-2xl text-gray-400 max-w-4xl mx-auto mb-12 leading-relaxed">
                Preparamos 3 caminhos estratégicos para o seu negócio. Escolha o plano que melhor se
                adapta ao momento da sua empresa e vamos acelerar juntos.
              </p>
            </motion.div>
          </div>
        </section>
              ...
              {[
                {
                  ...
                  title: "Velocidade",
                  desc: "Carregamento instantâneo",
                },
                {
                  icon: <Shield className="w-5 h-5" />,
                  title: "Segurança",
                  desc: "Dados e domínio protegidos",
                },
                {
                  icon: <Rocket className="w-5 h-5" />,
                  title: "Conversão",
                  desc: "Foco total em vendas",
                },
                {
                  icon: <MessageCircle className="w-5 h-5" />,
                  title: "Automação",
                  desc: "Atendimento inteligente",
                },
              ].map((item, i) => (
                <motion.div
                  key={i}
                ...
                >
                  ...
                  <h4 className="text-base font-bold uppercase tracking-widest mb-2 text-white">
                    {item.title}
                  </h4>
        ...
        <section className="py-20 relative">
          ...
          <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none -z-10">
            ...
            <div
              className="absolute bottom-1/4 right-1/4 w-[500px] h-[500px] bg-amber-600/5 blur-[120px] rounded-full animate-pulse"
                ...
                >
                  ...
                  <div className="mb-8 h-[160px] flex flex-col justify-start">
                    <div className="mb-6 flex items-center justify-between">
                      <div
                        className={`p-4 rounded-2xl ${plan.popular ? "bg-blue-500 text-white" : "bg-white/5 text-blue-400"}`}
                      >
                        {plan.icon}
                      </div>
                      {plan.popular && (
                    ...
                    <h3 className="text-4xl font-bold mb-3 font-['Bebas_Neue'] tracking-wide group-hover:text-blue-400 transition-colors">
                      {plan.name}
                    </h3>
                  ...
                  <div className="mb-10 p-8 bg-white/5 rounded-2xl border border-white/5 group-hover:border-blue-500/20 transition-colors">
                    <div className="flex items-baseline gap-1 mb-2">
                      <span className="text-base font-medium text-gray-500 uppercase tracking-tighter">
                        R$
                      </span>
                  ...
                  <div className="space-y-6 mb-12 flex-grow">
                    <p className="text-xs font-black text-gray-500 uppercase tracking-[0.2em] mb-6">
                      O que está incluso:
                    </p>
                        ...
                        <Tooltip key={idx}>
                          <TooltipTrigger asChild>
                            <div className="flex items-start gap-4 group/feature cursor-help">
                              <div
                                className={`w-8 h-8 rounded-xl flex items-center justify-center shrink-0 transition-all duration-300 mt-0.5 ${
                                  plan.id === "elite"
                              ...
                              <div className="flex flex-col">
                                <div className="flex items-center gap-1.5">
                                  <span className="text-gray-200 text-base font-bold tracking-tight group-hover/feature:text-white transition-colors leading-none mb-1">
                                    {feature.text}
                                  </span>
                                  <Info className="w-4 h-4 text-gray-600 group-hover/feature:text-blue-400 transition-colors" />
                                </div>
                                <span className="text-xs text-gray-500 font-medium tracking-tight group-hover/feature:text-blue-300 transition-colors">
                                  {feature.subtext}
                                </span>
                              </div>
                            </div>
                          ...
                          <TooltipContent className="max-w-[200px] bg-[#0F172A] border-blue-500/30 text-xs text-gray-300 p-3 rounded-xl shadow-2xl">
                            ...
                            {feature.subtext}. Este recurso garante que sua empresa tenha os
                            melhores padrões do mercado digital.
                          </TooltipContent>
                        </Tooltip>
                      ))}
                    </TooltipProvider>
        ...
        <section className="py-24 bg-gradient-to-b from-transparent via-blue-500/5 to-transparent">
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-5xl font-bold mb-4 font-['Bebas_Neue'] tracking-wider">
                Detalhamento dos Planos
              </h2>
              <p className="text-gray-400 max-w-2xl mx-auto">
                Compare o que cada investimento entrega e como ele impacta o crescimento da HCB.
              </p>
            </div>
                ...
                <div className="flex flex-col md:flex-row gap-8">
                  <div className="md:w-1/3">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <h3 className="text-2xl font-bold font-['Bebas_Neue'] tracking-wide">
                        Plano Essencial
                      </h3>
                    </div>
                    <p className="text-gray-400 text-sm mb-6">
                      Manutenção da base tecnológica para sua operação continuar rodando sem
                      interrupções.
                    </p>
                    <div className="p-5 bg-blue-500/5 rounded-xl border border-blue-500/10">
                      <p className="text-sm text-blue-300 font-bold uppercase mb-2">
                        Benefício Principal:
                      </p>
                      <p className="text-base text-gray-300 italic">
                        "Sua empresa sempre encontrada, com e-mails que passam confiança e domínio
                        garantido."
                      </p>
                    </div>
                  </div>
                  <div className="md:w-2/3 flex flex-col md:flex-row gap-8">
                    <div className="flex-1 space-y-6">
                      <h4 className="text-white font-bold text-lg uppercase tracking-widest border-l-2 border-blue-500 pl-3">
                        O que inclui:
                      </h4>
                      <ul className="space-y-4">
                        <li className="flex gap-3 text-base text-gray-300">
                          ...
                          <span>
                            <strong>Domínio .com.br:</strong> Sua marca protegida na internet (ex:
                            hcb-ar.com.br).
                          </span>
                        </li>
                        <li className="flex gap-3 text-base text-gray-300">
                          <Check className="w-5 h-5 text-blue-500 shrink-0" />
                          <span>
                            <strong>Hospedagem Premium:</strong> Servidores rápidos que garantem que
                            seu site não caia.
                          </span>
                        </li>
                        <li className="flex gap-3 text-base text-gray-300">
                          <Check className="w-5 h-5 text-blue-500 shrink-0" />
                          <span>
                            <strong>E-mails @hcb:</strong> Chega de usar Gmail para fechar negócios
                            de alto valor.
                          </span>
                        </li>
                      </ul>
                      <h4 className="text-white font-bold text-lg uppercase tracking-widest border-l-2 border-blue-500 pl-3 mt-8">
                        Exemplo Prático:
                      </h4>
                      <div className="bg-white/5 p-6 rounded-xl text-sm text-gray-400 leading-relaxed">
                        Imagine um cliente procurando por "ar condicionado automotivo" e encontrando
                        sua marca com um e-mail <strong>contato@hcb-ar.com.br</strong>. A percepção
                        de tamanho e seriedade da sua empresa muda instantaneamente.
                      </div>
                    </div>
                    <div className="flex-1 rounded-2xl overflow-hidden aspect-video md:aspect-[4/3] border border-white/10 group-hover:border-blue-500/30 transition-colors shadow-2xl relative">
                      ...
                      <div className="absolute inset-0 flex items-end p-6">
                        <span className="text-white font-bold text-sm uppercase tracking-widest bg-blue-500/80 px-3 py-1 rounded backdrop-blur-sm">
                          Base Sólida
                        </span>
                      </div>
                    </div>
              ...
              <div className="bg-gradient-to-br from-blue-600/10 to-transparent border border-blue-500/50 rounded-[2.5rem] p-8 md:p-12 relative overflow-hidden group">
                ...
                <div className="flex flex-col md:flex-row gap-8 relative z-10">
                  <div className="md:w-1/3">
                    ...
                    <p className="text-gray-400 text-sm mb-6">
                      Uma máquina de vendas 24h por dia. Seu site focado em converter visitantes em
                      orçamentos.
                    </p>
                    <div className="p-4 bg-blue-500/10 rounded-xl border border-blue-500/20">
                      ...
                      <p className="text-sm text-gray-300 italic">
                        "Converta curiosos em clientes reais através de um site rápido, bonito e
                        persuasivo."
                      </p>
                    </div>
                  </div>
                  <div className="md:w-2/3 flex flex-col md:flex-row gap-8">
                    <div className="flex-1 rounded-2xl overflow-hidden aspect-video md:aspect-[4/3] border border-white/10 group-hover:border-blue-500/50 transition-colors order-2 md:order-1 shadow-2xl relative">
                      ...
                      <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent opacity-60 group-hover:opacity-40 transition-opacity duration-500" />
                      <div className="absolute inset-0 flex items-end p-6">
                        <span className="text-white font-bold text-sm uppercase tracking-widest bg-blue-600/80 px-3 py-1 rounded backdrop-blur-sm">
                          Máxima Performance
                        </span>
                      </div>
                    </div>
                    <div className="flex-1 space-y-4 order-1 md:order-2">
                      <h4 className="text-white font-bold text-sm uppercase tracking-widest border-l-2 border-blue-500 pl-3">
                        O que inclui:
                      </h4>
                      <ul className="space-y-3">
                        <li className="flex gap-2 text-sm text-gray-300">
                          ...
                          <span>
                            <strong>Landing Page Premium:</strong> Design moderno que destaca seus
                            diferenciais (Off-road, Agrícola, etc).
                          </span>
                        </li>
                        <li className="flex gap-2 text-sm text-gray-300">
                          <Check className="w-4 h-4 text-blue-500 shrink-0" />
                          <span>
                            <strong>SEO Local:</strong> Configuração para aparecer no topo das
                            buscas em sua região.
                          </span>
                        </li>
                        <li className="flex gap-2 text-sm text-gray-300">
                          <Check className="w-4 h-4 text-blue-500 shrink-0" />
                          <span>
                            <strong>Botão flutuante WhatsApp:</strong> Facilita o contato imediato
                            do cliente.
                          </span>
                        </li>
                      </ul>
                      <h4 className="text-white font-bold text-sm uppercase tracking-widest border-l-2 border-blue-500 pl-3 mt-6">
                        Exemplo Prático:
                      </h4>
                      <div className="bg-blue-500/10 p-4 rounded-xl text-xs text-gray-300 leading-relaxed border border-blue-500/10">
                        Um dono de caminhonete vê seu anúncio, entra num site que carrega em menos
                        de 2 segundos, vê fotos reais do seu trabalho e clica no botão do WhatsApp.
                        Você recebe um lead já "quente".
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col md:flex-row gap-8">
                  <div className="md:w-1/3">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <h3 className="text-2xl font-bold font-['Bebas_Neue'] tracking-wide text-amber-400">
                        Plano Elite Digital
                      </h3>
                    </div>
                    <p className="text-gray-400 text-sm mb-6">
                      Gestão inteligente e atendimento automático. Escalabilidade total para sua
                      oficina.
                    </p>
                    <div className="p-4 bg-amber-500/5 rounded-xl border border-amber-500/10">
                      ...
                      <p className="text-sm text-gray-300 italic">
                        "Nunca mais perca um cliente por demora no atendimento. Gestão profissional
                        de leads."
                      </p>
                    </div>
                  </div>
                  <div className="md:w-2/3 flex flex-col md:flex-row gap-8">
                    <div className="flex-1 space-y-4">
                      <h4 className="text-white font-bold text-sm uppercase tracking-widest border-l-2 border-amber-500 pl-3">
                        O que inclui:
                      </h4>
                      <ul className="space-y-3">
                        <li className="flex gap-2 text-sm text-gray-300">
                          ...
                          <span>
                            <strong>Bot de Atendimento:</strong> Qualifica o cliente (marca, modelo,
                            defeito) antes de você falar com ele.
                          </span>
                        </li>
                        <li className="flex gap-2 text-sm text-gray-300">
                          <Check className="w-4 h-4 text-amber-500 shrink-0" />
                          <span>
                            <strong>CRM Básico:</strong> Painel para ver quem entrou em contato,
                            quem fechou e quem precisa de retorno.
                          </span>
                        </li>
                        <li className="flex gap-2 text-sm text-gray-300">
                          <Check className="w-4 h-4 text-amber-500 shrink-0" />
                          <span>
                            <strong>Relatório Mensal:</strong> Quantas pessoas visitaram e quantos
                            orçamentos foram gerados.
                          </span>
                        </li>
                      </ul>
                      <h4 className="text-white font-bold text-sm uppercase tracking-widest border-l-2 border-amber-500 pl-3 mt-6">
                        Exemplo Prático:
                      </h4>
                      <div className="bg-amber-500/5 p-4 rounded-xl text-xs text-gray-400 leading-relaxed border border-amber-500/5">
                        Um cliente manda mensagem às 22h. O Bot responde: "Olá! Qual o modelo do seu
                        carro?". Ele responde "Hilux 2022". O Bot já deixa o lead pronto no seu CRM
                        para você fechar o agendamento no dia seguinte cedo.
                      </div>
                    </div>
                    <div className="flex-1 space-y-6">
                      <h4 className="text-white font-bold text-sm uppercase tracking-widest border-l-2 border-amber-500 pl-3 mt-6">
                      ...
                      <div className="grid grid-cols-1 gap-4">
                        <div className="rounded-2xl overflow-hidden aspect-video md:aspect-[4/3] border border-white/10 group-hover:border-amber-500/40 transition-colors shadow-2xl relative">
                          ...
                          <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent opacity-60 group-hover:opacity-40 transition-opacity duration-500" />
                          <div className="absolute inset-0 flex items-end p-6">
                            <span className="text-amber-400 font-bold text-sm uppercase tracking-widest bg-amber-500/20 px-3 py-1 rounded backdrop-blur-sm border border-amber-500/30">
        ...
        <section className="py-24">
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold mb-4 font-['Bebas_Neue'] tracking-wider">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="p-6 bg-black/30 rounded-2xl border border-white/5">
                ...
                <h4 className="text-xl font-bold mb-3 font-['Bebas_Neue'] tracking-wide">
                  Velocidade
                </h4>
                <p className="text-gray-400 text-sm">
                  Um site rápido não apenas agrada o cliente, mas aumenta sua nota no Google,
                  reduzindo custos com anúncios.
                </p>
              </div>
              <div className="p-6 bg-black/30 rounded-2xl border border-white/5">
                <div className="w-12 h-12 bg-blue-500/20 rounded-lg flex items-center justify-center mb-6">
                ...
                <p className="text-gray-400 text-sm">
                  Abandone o e-mail amador e as redes sociais como única vitrine. Tenha uma casa
                  digital sólida e confiável.
                </p>
              </div>
              <div className="p-6 bg-black/30 rounded-2xl border border-white/5">
                <div className="w-12 h-12 bg-blue-500/20 rounded-lg flex items-center justify-center mb-6">
                ...
                <p className="text-gray-400 text-sm">
                  Não perca vendas por demora no WhatsApp. O CRM e a automação garantem que todo
                  lead seja atendido instantaneamente.
                </p>
              </div>
              <div className="p-6 bg-black/30 rounded-2xl border border-white/5">
                <div className="w-12 h-12 bg-blue-500/20 rounded-lg flex items-center justify-center mb-6">
                ...
                <p className="text-gray-400 text-sm">
                  Hospedagem blindada e certificados de segurança inclusos para garantir que seu
                  site esteja sempre online e seguro.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-24 bg-black/20">
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-gray-400 max-w-2xl mx-auto">
                Visão detalhada de cada recurso lado a lado.
              </p>
            </div>
              ...
              <table className="w-full border-collapse">
                <thead>
                  <tr className="border-b border-white/10">
                    <th className="py-8 px-6 text-left text-base font-bold uppercase tracking-widest text-gray-500">
                      Recursos
                    </th>
                    <th className="py-8 px-6 text-center text-base font-bold uppercase tracking-widest text-blue-400">
                      Starter
                    </th>
                    <th className="py-8 px-6 text-center text-base font-bold uppercase tracking-widest text-blue-500 bg-blue-500/5 rounded-t-3xl">
                      Profissional
                    </th>
                    <th className="py-8 px-6 text-center text-base font-bold uppercase tracking-widest text-amber-400">
                      Elite
                    </th>
                  </tr>
                </thead>
                <tbody className="text-gray-300">
                  {comparisonFeatures.map((row, i) => {
                    ...
                    return (
                      <tr
                        key={i}
                        className={`border-b border-white/5 hover:bg-white/[0.02] transition-colors ${isExclusive ? "bg-blue-500/[0.02]" : ""}`}
                      >
                        ...
                        <td className="py-5 px-4 text-center">
                          {row.essential ? (
                            ...
                            <X className="w-5 h-5 text-gray-800 mx-auto opacity-20" />
                          )}
                        </td>
                  ...
                  <details className="group [&_summary::-webkit-details-marker]:hidden">
                    <summary className="flex items-center justify-between p-6 cursor-pointer hover:bg-white/5 transition-colors select-none">
                      <div className="flex items-center gap-4">
                        <div
                          className={`p-2 rounded-lg ${plan.popular ? "bg-blue-500 text-white" : "bg-blue-500/10 text-blue-400"}`}
                        >
                          {plan.icon}
                        </div>
                        <div className="flex flex-col">
                          <span className="font-bold text-lg font-['Bebas_Neue'] tracking-wide">
                            {plan.name}
                          </span>
                      ...
                      <ul className="space-y-4 pt-6">
                        {comparisonFeatures.map((feat, i) => {
                          ...
                          return (
                            <li
                              key={i}
                              className={`flex items-center justify-between text-sm group/item p-2 rounded-lg ${isExclusive ? "bg-blue-500/5 border border-blue-500/10" : ""}`}
                            >
                              <div className="flex flex-col">
                                <span className="text-gray-400 group-hover/item:text-gray-200 transition-colors font-medium">
                                  {feat.label}
                                </span>
                                {isExclusive && (
        ...
        <section className="py-24 text-center">
          <div className="container mx-auto px-6 max-w-2xl">
            <h2 className="text-3xl font-bold mb-6 font-['Bebas_Neue'] tracking-wider">
              Pronto para dar o próximo passo?
            </h2>
            <p className="text-gray-400 mb-10 text-lg leading-relaxed">
              Qualquer dúvida que tiver sobre os planos, estou à disposição para conversarmos e
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="text-center mb-8">
                ...
                <p className="text-gray-400">
                  Você selecionou o{" "}
                  <span className="text-blue-400 font-bold">{selectedPlan.name}</span>.
                </p>
              </div>
                ...
                <ul className="space-y-3">
                  {selectedPlan.features.slice(0, 3).map((feature: any, i: number) => (
                    <li key={i} className="flex items-center gap-3 text-sm text-gray-300">
                      <div
                        className={`${selectedPlan.id === "elite" ? "text-amber-500" : "text-blue-500"} shrink-0`}
                      >
                        {feature.icon}
                      </div>
                  ...
                  <li className="text-xs text-gray-500 italic mt-2">
                    + todos os outros benefícios detalhados.
                  </li>
                </ul>
              ...
              <div className="space-y-4">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-amber-200/60 leading-tight">
                        Parece que seu navegador bloqueou a janela. Tente clicar no botão abaixo
                        novamente ou copie a mensagem acima.
                      </p>
                    </div>
                  </motion.div>
                )}
                ...
                <p className="text-center text-xs text-gray-500">
                  Ao clicar, você será direcionado para o atendimento humano para os próximos
                  passos.
                </p>
              </div>
            </motion.div>
