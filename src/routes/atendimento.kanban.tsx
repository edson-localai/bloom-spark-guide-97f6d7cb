        ...
        <div className="p-8 pb-4 flex justify-between items-center">
          <div>
            ...
            <p className="text-zinc-500 text-sm">
              Arraste os cards para mudar o status do atendimento.
            </p>
          </div>
    ...
    <div className="w-80 shrink-0 flex flex-col h-full bg-[#0F1117]/50 rounded-2xl border border-[#1F232E]">
      <div className="p-4 flex items-center justify-between border-b border-[#1F232E]">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[10px] px-1.5 py-0.5 rounded bg-[#1F232E] text-zinc-500">
            {cards.length}
          </span>
        </div>
...
function KanbanCard({ card }: any) {
  ...
  return (
    <motion.div
      ...
      whileHover={{
        y: -4,
        borderColor: "rgba(0, 204, 238, 0.4)",
        boxShadow: "0 0 20px rgba(0, 204, 238, 0.1)",
      }}
      ref={setNodeRef}
      style={style}
      {...listeners}
    ...
    >
      ...
      <h4 className="text-sm font-semibold text-zinc-200 mb-1 truncate">
        {card.contact?.name || card.whatsapp_chat_id}
      </h4>
      ...
      <div className="flex items-center justify-between pt-3 border-t border-[#1F232E]">
        <div className="flex items-center gap-1.5 text-zinc-600">
          ...
          <span className="text-[10px] font-medium">
            {new Date(card.last_message_at).toLocaleTimeString([], {
              hour: "2-digit",
              minute: "2-digit",
            })}
          </span>
